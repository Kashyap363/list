...
print("Middle country(ies):",countries[middle])

# Divide the countries list into two equal lists if it is even if not one more country for the first half.
country=['India', 'Russia', 'UK', 'Finland', 'USA', 'Singapore', 'Denmark']
mid=len(country)//2
...
# ['India', 'Russia', 'UK', 'Finland', 'USA', 'Singapore', 'Denmark']. Unpack the first three countries and the rest as scandic countries.
